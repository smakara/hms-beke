                ...
                <div class="col-sm-12 col-xl-6">
                    <div class="card">
                        <div class="card-header">
                            <i class="fa fa-align-justify"></i>Health Information's Portal - Patient Details
                        ...
                        <div class="card-body">
                            <p>
                                ...
                                <a class="btn btn-primary" data-toggle="collapse" href="#collapseExample1" aria-expanded="false" aria-controls="collapseExample">Update Patient Status</a>
                            </p>
                                    ...
                                    <form action="{{url('updatestatus')}}" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group  col-sm-12">
                                                <select name="patstatus" class="form-control">
                                ...
                                <div class="card mb-0">
                                    ...
                                    <div class="collapse" id="collapseTwo" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion">
                                        ...
                                        <div class=" pull-right ">
                                            <p>
                                                <button disabled="true" class="btn btn-block btn-primary" type="button"  data-toggle="modal" data-target="#createassessmentModal"><i class="icon-plus"></i> Creat Assessment</button>
                                            </p>
                                        </div>
                                    </div>
                                </div>
