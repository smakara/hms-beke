                        ...
                        <div class="card-group">
                            <div class="card p-4">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <button id="btnlogin" type="submit" class="btn btn-primary px-4" type="button">Login</button>
                                        </div>
                                          <div class="col-6">
                                              <a href="{{url('donations')}}"  >Click here to donate</a>
                                        </div>
                            ...
                            <div class="card text-white bg-primary py-5 d-md-down-none" style="width:44%">
                                <div class="card-body text-center">
                                    <div>
                                    	  <h4>Ingutsheni Central Hospital</h4>
                                        <h5 style="font-size: 18px;">Patient Information Management System</h5>
